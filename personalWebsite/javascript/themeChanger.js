...
function initializeThemes() {
   ...
   let color1 = rootStyle.getPropertyValue('--dark');
   let color2 = rootStyle.getPropertyValue('--brightContrast');
   let color3 = rootStyle.getPropertyValue('--bright');
   let color4 = rootStyle.getPropertyValue('--offWhite');
   getAndUpdateSelectedTheme();
   getCustomTheme();
   if (customTheme == null) {
...
function updateRootVars(theme) {
   ...
   root.style.setProperty('--dark', theme.hex1);
   root.style.setProperty('--brightContrast', theme.hex2);
   root.style.setProperty('--bright', theme.hex3);
   root.style.setProperty('--offWhite', theme.hex4);
}
